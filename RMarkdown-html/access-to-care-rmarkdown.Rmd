...
hospital_locations <- pin_get("atc-hospital-locations", board = boardname) 
county_shapes <- pin_get("atc_shapes", board = boardname)
county_hospitals <-  pin_get("atc-county_hospitals", board = boardname) %>%
...
counties <- county_hospitals %>% 
  ...
  left_join(county_shapes, by = "county_id") %>%
  filter(!is.na(county))
